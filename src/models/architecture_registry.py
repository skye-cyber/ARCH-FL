...
class ArchitectureRegistry:
    ...
    def __init__(self):
        ...
        self._config_dir = Path(__file__).resolve().parent.parent.parent / "config/model"
    ...
    def register_architecture(self, arch_name: str, 
                             config: Dict[str, Any],
                             description: str = "",
    ...
    def register_architecture_from_file(self, arch_name: str, 
                                       config_file: str,
                                       description: str = "",
                                       compatible_datasets: Optional[List[str]] = None) -> None:
        """
    ...
    def get_compatible_architectures(self, dataset_name: str) -> List[str]:
        ...
        for arch_name, arch_info in self.architectures.items():
            ...
            if (not arch_info['compatible_datasets'] or 
                dataset_name in arch_info['compatible_datasets']):
        ...
        if 'architecture' in config:
            ...
            if 'conv_layers' in arch_config:
                ...
                for i, layer in enumerate(conv_layers):
                    required_layer_fields = ['out_channels', 'kernel_size', 'stride', 'padding']
    ...
    def create_model_from_architecture(self, arch_name: str, 
        ...
        try:
            ...
            return factory.create_model(config, input_shape or config.get('input_shape'))
        except ImportError:
    ...
    def register_custom_architecture(self, arch_name: str,
                                    config: Dict[str, Any],
                                    description: str = "",
                                    compatible_datasets: Optional[List[str]] = None) -> None:
        """
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Test MediumCNN
        model_medium = registry.create_model_from_architecture("medium_cnn", input_shape=(1, 224, 224))
        ...
        registry.register_custom_architecture("custom_test", custom_config, 
