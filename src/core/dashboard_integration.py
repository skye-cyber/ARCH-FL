...
class DashboardConnector:
    ...
    def update_experiment_status(
        self, experiment_id: int, status: str, metrics: Optional[Dict[str, Any]] = None
    ) -> None:
    ...
    def add_experiment_result(
        self, experiment_id: int, result_data: Dict[str, Any]
    ) -> int:
...
def create_dashboard_callback(
    experiment_id: int, dashboard_connector: DashboardConnector
) -> ProgressCallback:
