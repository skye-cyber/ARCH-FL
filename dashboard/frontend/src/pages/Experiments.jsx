                ...
                <AnimatePresence>
                    {actionResult && (
                        <motion.div
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            exit={{ opacity: 0, y: -20 }}
                            className={`mb-6 p-4 rounded-xl flex items-center ${actionResult.type === "success"
                        ...
                        >
                            ...
                            <p
                                className={`text-sm ${actionResult.type === "success"
                                    ? "text-green-700"
                                    : "text-red-700"
                                    }`}
                            >
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div className="relative">
                                                    ...
                                                    {/* Action Menu - Positioned relative to this button */}
                                                    <AnimatePresence>
                                                        {actionMenuOpen === experiment.id && (
                                                            <motion.div
                                                                ...
                                                                style={{ zIndex: 1000 }}
                                                            >
                                                                {getSingleActions(experiment).map((action) =>
                                                                    action.link ? (
                                                                        <Link
                                                                            key={action.id}
                                                                            to={action.link}
