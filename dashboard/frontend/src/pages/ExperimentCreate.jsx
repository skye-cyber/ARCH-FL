...
export default function ExperimentCreate() {
    ...
    const handleIIDChange = useCallback((source = 'iid') => {
        const value = IID.current.checked

        if (source === 'iid') {
            NON_IID.current.checked = !value
            //NON_IID.current.value = !value
            setExperiment({ ...experiment, iid: IID.current.checked })

        } else {
            IID.current.checked = value
            setExperiment({ ...experiment, iid: IID.current.checked })
        }
    });
                                ...
                                <div className="flex space-x-4">
                                    ...
                                    <label className="flex items-center cursor-pointer">
                                        <input
                                            ...
                                            onChange={() => handleIIDChange('non_iid')}
                                            className="sr-jonly"
                                        />
                                        <div
                                        ...
                                        >
                                            <span className="text-sm select-none">Non-IID</span>
                                        </div>
                                    </label>
                                </div>
                            </div>
