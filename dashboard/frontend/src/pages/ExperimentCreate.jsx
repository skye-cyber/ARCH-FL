...
export default function ExperimentCreate() {
  ...
  return (
    <section className="container mx-auto w-full fllex justify-center">
      <div className="space-y-4">
        ...
        <div className="flex flex-cols lg:flex-row gap-4 w-full">
          <div className="w-[20%] bg-white min-h-full rounded-md shadow-md p-4">
            ...
            <div className="space-y-4">
              ...
              <div className="relative group">
                ...
                <div className="relative flex items-center gap-4 p-4 bg-white rounded-lg border border-gray-100 hover:border-transparent transition-all duration-300 cursor-pointer">
                  <div className="w-10 h-10 bg-gradient-to-br from-amber-500 to-orange-500 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                    <svg
