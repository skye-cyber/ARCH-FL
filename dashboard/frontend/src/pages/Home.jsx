...
export default function Home() {
    ...
    const [systemInfo, setSystemInfo] = useState({
        system_info: {
            cpu: { percent: 0 },
            memory: { used: 0, used_human: 0, avilable: 0, available_human: 0, percent: 0 },
            disk: { used: 0, used_human: 0, available: 0, available_human: 0, percent: 0 },
            uptime: '-',
        },
        network: 0,
    });
    ...
    useEffect(() => {
        const fetchStats = async () => {
            ...
            try {
                ...
                console.log(systemInfoResponse.data);
                ...
                const sortedExperiments = [...experimentsResponse.data].sort(
                    (a, b) => new Date(b.created_at) - new Date(a.created_at),
                );
                setRecentExperiments(sortedExperiments.slice(0, 3));
                ...
                >
                        ...
                        {statCards.map((stat) => (
                            ...
                            >
                                <div className="flex items-start justify-between mb-1">
                                    ...
                                    {stat.change && (
                                        <span
                                            className={`inline-flex items-center px-1 py-1 rounded-full text-xs font-normal
                    ${stat.trend === "up"
                    ...
                    >
                                ...
                                {recentExperiments.length > 0 ? (
                                    recentExperiments.map((exp, idx) => {
                                        ...
                                        if (exp.status === "completed") {
                                            ...
                                            progress = 75; // Assume 75% for running experiments
                                            ...
                                            >
                                                <div className="flex-1">
                                                    <div className="flex items-center mb-2">
                                                        ...
                                                        <span
                                                            className={`ml-2 text-xs px-2 py-0.5 rounded-full ${exp.status === "running"
                                                        ...
                                                        <div className="flex-1 max-w-md">
                                                            <div className="h-1.5 bg-gray-200 rounded-full overflow-hidden">
                                                                <motion.div
                                                                    ...
                                                                    className={`h-full rounded-full ${exp.status === "running"
                                                                        ? "bg-blue-600"
                                                                        : exp.status === "completed"
                                                                            ? "bg-green-600"
                                                                            : "bg-yellow-600"
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
                                ...
                                <Link to='https://github.com/skye-cyber/ARCH-FL.git' target="_blank" className="mt-4 text-xs text-blue-600 hover:text-blue-700 font-medium flex items-center">
                    ...
                    >
                        {[
                            ...
                            {
                                label: "Success Rate",
                                value: footerMetrics.successRate,
                                change: "-%",
                            },
                        ].map((metric) => (
                            <div
