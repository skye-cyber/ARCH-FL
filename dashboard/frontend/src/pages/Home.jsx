    ...
    const fetchStats = async () => {
      ...
      try {
        ...
        setOverviewStats({
          ...
          storageUsed: "234 GB", // This would come from actual storage API
          avgAccuracy: `${(avgAccuracy * 100).toFixed(1)}%`,
          uptime: "99.9%",
        });

        // Set system metrics (simulated for now)
        setSystemMetrics({
          cpu: 23,
          memory: 4.2,
          network: 48,
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
                ...
                <button className="mt-4 text-xs text-blue-600 hover:text-blue-700 font-medium flex items-center">
