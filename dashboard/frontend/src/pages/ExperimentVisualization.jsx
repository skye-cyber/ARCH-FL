        ...
        const fetchExperiment = async () => {
            try {
                ...
                if (experimentResponse.data.dataset_name) {
                    const datasetResponse = await datasetService.getByName(experimentResponse.data.dataset_name)
        ...
        <div className="space-y-6">
                                            ...
                                            >
                                                <div className="text-center">
                                                    <motion.div
                                                        ...
                                                        className={`w-16 h-16 rounded-xl flex items-center justify-center mb-2 ${isActive
            ...
            <div className="grid grid-cols-4 gap-6">
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-100">
                        <div className="flex items-center text-xs text-gray-600">
                            ...
                            <div className="flex gap-4">
                                <div>{experiment.datasetInfo.size.human}</div> <div>{experiment.datasetInfo.metadata.num_classes} classes</div>
                            </div>
                        </div>
                    </div>
                </motion.div>
                ...
                >
                    <div className="flex items-start justify-between mb-3">
                        <div
                            className={`p-2.5 rounded-xl ${experiment.iid ? "bg-yellow-100" : "bg-orange-100"
                                }`}
                        >
                            <GitBranch
                                className={`w-5 h-5 ${experiment.iid ? "text-yellow-600" : "text-orange-600"
                                    }`}
                            />
                        </div>
                                    ...
                                    if (
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`w-8 h-8 rounded-lg text-sm font-medium transition-colors ${round === selectedRound
