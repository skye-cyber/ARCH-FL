...
| **Kitty K. Wong et al. (2024)** | Introduces **FedMLP** for **multi-label classification under task heterogeneity** (label missing). Highly relevant for your use of CheXpert & MIMIC-CXR, providing a method to handle missing labels across clients. | *MICCAI 2024 Proceedings* |

These references directly support your project's focus on the challenges of **non-IID data** and **privacy-preserving techniques** in federated medical imaging.
